...
class EDI_CLI {
	...
	public function __construct() {
		...
		WP_CLI::add_command( 'edi clear', array( $this, 'dummy_function' ) );
		WP_CLI::add_command( 'edi test', array( $this, 'dummy_function' ) );
	}
	...
	protected function subcommand_clear() {
		delete_option( 'edi' );
		...
		WP_CLI::success( 'EDI data cleared.' );
		WP_CLI::halt( 0 );
	}

	protected function subcommand_test() {
		global $argv;
